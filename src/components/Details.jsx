  ...
  return (
    <div>
       ...
       <div className="card-container flex my-4 text-gray-900 px-12 mt-10">
            <figure className=' w-96 mx-auto flex-5/12 shadow-lg'>
        ...
        <div className="instructions-container flex-1">
            ...
            <p className='w-[80%] mx-auto font-sans text-lg leading-8 text-justify h-56 overflow-y-auto mb-5 scrollbar-none'>{meal.strInstructions}</p>
            <div className="video-link w-[80%] mx-auto flex justify-around">
                ...
                <span className=' border shadow-lg border-b-green-600 px-5 py-2 text-red-500 text-lg rounded-md'>{meal.strTags ? meal.strTags : "None"}</span>
                <a href={meal.strYoutube} className='px-5 py-2 border shadow-lg bg-green-400 hover:bg-green-500 hover:text-white rounded-lg youtube-btn'>Youtube</a>
            </div>
        </div>
       </div>
